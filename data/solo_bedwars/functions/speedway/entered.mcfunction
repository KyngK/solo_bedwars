execute if score #entered_speedway global matches 1 run setblock -40 63 -88 structure_block{mode:"LOAD",ignoreEntities:0b,name:"solo_bedwars:speedway/red_base",posX:0,posY:1,posZ:0}
